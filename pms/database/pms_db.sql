...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 04, 2022 at 05:09 AM
...
INSERT INTO `patient` (`id`, `patient_name`, `species`, `breed`, `color`, `age`, `gender`) VALUES
(2, 'Brownie', 'Dog', 'Aspin', 'Brown', 3, 'Male');
...
(6, '2022-09-01', '2022-10-01', '110/60', '15', 'indigestion', 2),
(7, '2022-09-01', '2022-10-01', '110/60', '15', 'indigestion', 2);
...
(3, 'Draxer', 'Idatoha', 'bd0ad1a5e9999d9bd885d0c24494b504', '166195223720220824_121939.png');
...
--
ALTER TABLE `patient_visits`
  ADD CONSTRAINT `fk_patients_visit_patient_id` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`);
COMMIT;
